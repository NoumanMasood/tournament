...
export class TournamentEditComponent implements OnInit {
  ...
  singleItem;
  error = '';
  constructor(private spinner: NgxSpinnerService,public formBuilder: FormBuilder,private tournamentService: TournamentService,private storage: AngularFireStorage, public route: ActivatedRoute) {
   }
  ...
  public ngOnInit() {
    ...
    this.tournamentService.getTournaments().subscribe((res) => {
      ...
      this.formTournament.patchValue({
        ...
        secondPrizeMoney: this.singleItem.secondPrizeMoney,
        thirdPrizeMoney: this.singleItem.thirdPrizeMoney,
  ...
  onSubmit() {
    ...
    this.formTournament.value.name = !this.formTournament.value.name ? this.singleItem.name : this.formTournament.value.name;
    this.formTournament.value.description = !this.formTournament.value.description ? this.singleItem.description : this.formTournament.value.description;
    this.formTournament.value.entryFee = !this.formTournament.value.entryFee ? this.singleItem.entryFee : this.formTournament.value.entryFee;
    this.formTournament.value.numberOfPlayer = !this.formTournament.value.numberOfPlayer ? this.singleItem.numberOfPlayer : this.formTournament.value.numberOfPlayer;
    this.formTournament.value.prizeMoney = !this.formTournament.value.prizeMoney ? this.singleItem.prizeMoney : this.formTournament.value.prizeMoney;
    this.formTournament.value.banner = !this.formTournament.value.banner ? this.singleItem.banner : this.formTournament.value.banner;
    this.formTournament.value.secondPrizeMoney = !this.formTournament.value.secondPrizeMoney ? this.singleItem.secondPrizeMoney : this.formTournament.value.secondPrizeMoney;
    this.formTournament.value.thirdPrizeMoney = !this.formTournament.value.thirdPrizeMoney ? this.singleItem.thirdPrizeMoney : this.formTournament.value.thirdPrizeMoney;
    this.formTournament.value.startDate = !this.formTournament.value.startDate ? this.singleItem.startDate : this.formTournament.value.startDate;
